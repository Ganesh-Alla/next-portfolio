    ...
    >
      <div className="max-w-6xl p-8">
        ...
        <div className="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-3 lg:w-2/3 m-auto">
          ...
          >
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3KCdLG0DPTqEMLddE-qdHG7LIlnyNuVLwDL2nU2wLTNZCyOUYUCricJNvWKPanp5CkKk&usqp=CAU"
              alt="HTML"
              className="w-full h-4/5 mb-4 rounded-lg"
            />
            <h3 className="text-xl font-semibold text-center">Supabase</h3>
          </div>
